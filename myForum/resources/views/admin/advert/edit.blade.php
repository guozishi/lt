        ...
        <form role="form" action="{{ url('/admin/advert/update') }}" method="post" enctype="multipart/form-data">
          ...
          {{ csrf_field() }}
			<div class="wrapper-md ng-scope" ng-controller="ToasterDemoCtrl">
			  ...
			  <div class="row">
			    <div class="col-sm-6">
			      <div class="form-group">
			        ...
			        <input type="text" class="form-control ng-pristine ng-untouched ng-valid" name="atitle" placeholder="请输入广告名称..." ng-model="toaster.title" value="{{ $data->atitle }}">
			      </div>

			      <div class="form-group">
			        <label><font><font>广告描述</font></font></label>
			        <textarea class="form-control ng-pristine ng-untouched ng-valid" name="adesc" placeholder="请对广告进行描述..." rows="5" ng-model="toaster.text">{{ $data->adesc }}</textarea>
			      </div>
			  ...
			  <button class="btn btn-info" ng-click="pop()"><font><font>点击更新</font></font></button>
