            ...
            <!-- 正确提示信息 -->
                ...
                @foreach($data as $item)
                    <tr>
                        ...
                        <td><a href="{{ url('/admin/roles') }}/{{ $item->role_id }}/edit"><span class="label bg-success">修改</span>&nbsp; &nbsp;<a href="{{ url('/admin/link') }}/{{ $item->role_id }}/edit"><span class="label bg-success">查看权限</span>&nbsp; &nbsp;&nbsp;</a><a href="javascript:;" onclick="roles({{ $item->role_id }})"><span class="label bg-danger">删除</span></a></td>
                    </tr>
                @endforeach
                    </tbody>
                </table>
