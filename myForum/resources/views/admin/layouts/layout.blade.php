          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu animated fadeInRight w">
              ...
              <li>
                  ...
                  <a ui-sref="app.docs" href="{{ asset('/admin/pass') }}"></a>
...
@yield('content')
    ...
    <div class="app-footer wrapper b-t bg-light">
      <span class="pull-right">1.0.0
          <a href="#app" class="m-l-sm text-muted"><i class="fa fa-long-arrow-up"></i></a>
      </span>
      &copy; 2017  兄弟模板  ❤ 用爱去收集
        <a href="http://www.guozishi.shop/" target="_blank" title="兄弟模板"></a>
    </div>
    <!-- / footer -->
  </div>
  <!-- jQuery -->
